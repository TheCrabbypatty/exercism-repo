...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if set(dish_ingredients) <= set(VEGAN):
        d_type = "VEGAN"
    elif set(dish_ingredients) <= set(VEGETARIAN):
        d_type = "VEGETARIAN"
    elif set(dish_ingredients) <= set(PALEO):
        d_type = "PALEO"
    elif set(dish_ingredients) <= set(KETO):
        d_type = "KETO"
    else:
        d_type = "OMNIVORE"
        
    return dish_name + f": {d_type}"
...
def tag_special_ingredients(dish):
    ...
    return name, set(tuple(ingredients)) & set(SPECIAL_INGREDIENTS)
...
def compile_ingredients(dishes):
    ...
    for ingredients in dishes:
        combined_list = combined_list | ingredients
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    return list(set(tuple(dishes)) - set(tuple(appetizers)))
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    set_dishes = set.union(*dishes)
    return set_dishes.symmetric_difference(intersection)
